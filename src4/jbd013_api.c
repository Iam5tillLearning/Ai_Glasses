...
void display_image(uint16_t row, uint16_t col, uint8_t *pBuf, uint32_t len) {
    ...
    usleep(1);              //1ms (8MHz) 或 0.5ms (16MHz)
}
...
void pixel_test(void) {
    ...
    display_image(0, 0, image, sizeof(image));
    display_image(1, 0, image, sizeof(image));
    display_image(0, 300, image, sizeof(image));
    display_image(1, 300, image, sizeof(image));
    display_image(0, 600, image, sizeof(image));
    display_image(1, 660, image, sizeof(image));

    display_image(239, 0, image, sizeof(image));
    display_image(240, 0, image, sizeof(image));
    display_image(239, 300, image, sizeof(image));
    display_image(240, 300, image, sizeof(image));
    display_image(239, 600, image, sizeof(image));
    display_image(240, 600, image, sizeof(image));

    display_image(478, 0, image, sizeof(image));
    display_image(479, 0, image, sizeof(image));
    display_image(478, 300, image, sizeof(image));
    display_image(479, 300, image, sizeof(image));
    display_image(478, 600, image, sizeof(image));
    display_image(479, 600, image, sizeof(image));
}